...
const { parseJSON, createRandomString } = require("../../helper/utlities");
    ...
    data.read("tokens", token, (err1, tokenData) => {
      if (!err1 && tokenData) {
        ...
        data.read("users", tokenData?.phone, (err2, userData) => {
          if (!err2 && userData) {
            tokenHandler._token.verify(token, tokenData?.phone, (tokenIsValid) => {
              if (tokenIsValid) {
                ...
                if (userChecks.length < environments.maxChecks) {
                  ...
                  data.create("checks", checkId, checkObject, (err3) => {
                    if (!err3) {
                      ...
                      data.update("users", tokenData?.phone, userObject, (err4) => {
                        if (!err4) {
